from database.sqlite.roster import delete_roster_user, get_roster_user, get_rosters_user, save_rosters, update_subscription
...
def helper_set_rosters(username_target, item, updating=False):
    if(updating):
        ...
        print(f"SAVED ROSTER ITEM: {username_target}, {item}")
